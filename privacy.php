...
<main id="body-inner">
    ...
    <div id="tt-content-wrap">
        <div id="page-header" class="ph-full ph-full-m ph-cap-xxxxlg ph-center 
              ph-image-parallax ph-caption-parallax">
            <div class="page-header-inner tt-wrap">
                <div class="ph-caption">
                    <div class="ph-caption-inner">
                        <h1 class="ph-caption-title">PRIVACY POLICY</h1>
                    </div>
                </div>
            </div>
        </div>
        <div id="tt-page-content">
            <div class="tt-section padding-bottom-xlg-120">
                <div class="tt-section-inner tt-wrap max-width-1000">
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal" style="margin-top: 50px;">
                        About The Policy
                    </h3>
                    <p>At California Web Hub the protection of our customers is our top need on
                        https://californiawebhub.com/ and we regard it as our own. In spite of the fact
                        that we gather data from our customers, it is just used to make enhancements in our client
                    ...
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Personal Information Collected</h3>
                    <p>The data gathered by California Web Hub incorporates the customer’s name, email,
                        postage information and telephone number. These are bits of data that the customer gives us
                        while requesting or while sparing the data with our organization. We may likewise utilize
                        the email addresses or street numbers which we get through our mailing framework, for
                        example, our Contact Us Form for reacting to remarks, questions and so on.</p>
                    ...
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Use of Collected Data</h3>
                    ...
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Newsletter Opt-out</h3>
                    <p>On the off chance that you no more wish to get our pamphlet and limited time correspondences,
                        ...
                        correspondence or by messaging us at Or calling us at +1 (949) 994-9191 </p>
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Social Media (Features) and Widgets</h3>
                    ...
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">3rd Party Sharing</h3>
                    ...
                    <p>We use credit card processing companies to bill you for services. These organizations don’t
                        ...
                        us.</p>
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Security of Personal Information</h3>
                    ...
                    <p>In the event that you have any inquiries concerning security on our Web website, you can send
                        email us at info@californiawebhub.com</p>
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Access of Registered Accounts</h3>
                    ...
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Changing and Deleting/Unsubscribing
                        Accounts</h3>
                    ...
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Cookies and Their Use</h3>
                    ...
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Clear Gifs (Web Beacons/Web Bugs)</h3>
                    <p>We utilize a product innovation called clear gifs (a.k.a. Web Beacons/Web Bugs), that help us
                        ...
                        identifiable data.</p>
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Testimonials</h3>
                    ...
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Links to Other Web Sites</h3>
                    ...
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Notice of the Changes in Privacy Policy
                    </h3>
                    <p>In the event that we choose to change our protection strategy, we will present those
                        ...
                        results.</p>
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Legal Disclaimer</h3>
                    ...
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Reactivation Policy:</h3>
                    <p>If a client becomes unresponsive for a month or more, the project will be considered closed. A
                        reactivation fee (40% of the initial amount) will apply if the project needs to be restarted.
                    </p>
                    <h3 class="tt-font-alter tt-text-uppercase tt-text-reveal">Questions</h3>
                    <p>On the off chance that you have any inquiries with respect to our Privacy Policy or our
                        utilization of your data, call our toll free number 
                        <a href="tel:<?php echo $locNumber; ?>"><?php echo $locNumber; ?></a>
                        or email us on 
                        <a href="mailt:<?php echo $locEmail; ?>"><?php echo $locEmail; ?></a>
                    </p>
                </div>
            </div>
        </div>
